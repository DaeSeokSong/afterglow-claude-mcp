  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        Claude Code에 등록하면 <code>init · create · handoff · sign · resume · list · inspect · ask · edit · council · council_summary · history · audit · recalibrate · correct · archive · version · access · interview · export · import · verify · status · gc · slack</code> 25 개 슬래시 명령이 동작.
      </td>
    </tr>
    <tr>
      <td>
...
│  │  └─ tools/            ← 25 도구: …+ interview · export · import · verify · status · gc · slack
│  └─ test/                ← vitest 213 + stdio 핸드셰이크 (25 도구)
│
└─ docs/
...
- [x] **MCP 서버 25 도구**: `init` · `create` · `handoff` · `sign` · `resume` · `list` · `inspect` · `ask` · `edit` · `council` · `council_summary` · `history` · `audit` · `recalibrate` · `correct` · `archive` · `version` · `access` · **`interview`** · **`export`** · **`import`** · **`verify`** · **`status`** · **`gc`**
...
- [x] **Slack 연동** (`afterglow_slack` — test/digest/share, Incoming Webhook)
- [x] vitest 213개 + stdio 핸드셰이크 (25 도구 전체 검증)
