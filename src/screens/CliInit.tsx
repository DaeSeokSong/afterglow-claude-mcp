  ...
  return (
    <div className="cli-page">
      <div className="cli-page-h">
        ...
        <h2>한 번만 하면 됩니다.</h2>
        <p>
          MCP를 등록하고 폴더 위치 한 번 정하면 끝. 별도의 모델 학습이나 GPU는 필요 없어요 — 퇴사자의 지식은 Claude의
          컨텍스트로 주입됩니다.
        </p>
      </div>
      ...
      <Terminal title="claude-code  ·  설치">
        ...
        <T.Q
          q="데이터 저장 위치"
          required
          hint="기본: ~/.claude/afterglow/  — 폴더 안에 각 퇴사자 폴더가 만들어집니다"
        />
        ...
        <T.Q
          q="기본 임베딩 모델"
          required
          hint="RAG 검색용. 파일 인덱싱에만 사용 — Claude 호출에는 영향 없음"
        >
          ...
          <T.Line color="rgba(245,240,228,0.55)" style={{ paddingLeft: 0 }}>
            {`  2. nomic-embed-text-v1.5 (로컬 · 오픈소스)`}
          </T.Line>
          <T.Line color="rgba(245,240,228,0.55)" style={{ paddingLeft: 0 }}>
            {`  3. bge-m3 (로컬 · 다국어 강함)`}
          </T.Line>
        ...
        <T.Dim>
          → ~/.claude/commands/ 은 Claude Code 권장 경로. afterglow/ 하위 폴더로 네임스페이스됩니다.
        </T.Dim>
        <T.Br />
      ...
      <div className="helper-row">
        <div className="helper-card">
          ...
          <p style={{ marginBottom: 8, lineHeight: 1.65 }}>
            <b>① 셸에서 직접</b> — 일회성 호출용.
          </p>
          <span className="h-cmd">claude /afterglow ask jiyoon "..."</span>
          <p style={{ marginTop: 12, marginBottom: 8, lineHeight: 1.65 }}>
            <b>② Claude Code REPL 안에서</b> — 대화 중 호출.{' '}
            <code
              style={{
        ...
        <div className="helper-card">
          ...
          <p>
            Claude Code는 Anthropic의 Claude를 호출해요. 우리가 만든 LoRA 가중치를 거기서 못 돌립니다. 대신 퇴사자의
            톤과 자료를 Claude의 컨텍스트에 함께 넣어 호환성을 100%로 유지해요.
          </p>
        </div>
        <div className="helper-card">
          ...
          <span className="h-cmd" style={{ marginTop: 6 }}>
            claude /afterglow config set embedding bge-m3
          </span>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="cli-page">
      <div className="cli-page-h">
        ...
        <p>
          자료는 파일·폴더·URL·Confluence/Jira/Notion 페이지 어떤 형식이든 받습니다. 모두 인덱싱돼서 Claude에게
          전달할 시스템 프롬프트와 RAG 인덱스가 만들어져요. <b>모델 학습은 일어나지 않습니다</b> — 그래서 Claude
          Code와 100% 호환돼요.
        </p>
      </div>
      ...
      <Terminal title="claude-code  ·  새 에이전트">
        <T.Prompt>
          claude /afterglow create <span style={{ color: '#FFE3C0' }}>jiyoon</span>
        </T.Prompt>
        <T.Br />
        ...
        <T.Q
          q="자료 소스"
          required
          hint="여러 줄 입력 가능 — 한 줄에 하나, 빈 줄로 종료. 파일/폴더/URL 무엇이든 OK"
        >
          <T.Line color="rgba(245,240,228,0.7)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}• .pdf · .md · .txt · .docx · .jsonl · .csv · 폴더 경로
          </T.Line>
          <T.Line color="rgba(245,240,228,0.7)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}• Confluence URL  ·  Jira URL  ·  Notion URL
          </T.Line>
          <T.Line color="rgba(245,240,228,0.7)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}• GitHub repo URL  ·  Google Docs URL  ·  일반 웹페이지
          </T.Line>
          <T.Br />
          <T.Answer>./materials/</T.Answer>
          <T.Line color="#8FBA70" style={{ paddingLeft: 18 }}>
            {'   '}+ 12 files detected (PDF, Markdown, CSV)
          </T.Line>
          <T.Answer>https://connecteve.atlassian.net/wiki/spaces/DESIGN/</T.Answer>
          <T.Line color="#8FBA70" style={{ paddingLeft: 18 }}>
            {'   '}+ Confluence space · 142 pages{' '}
            <span style={{ color: '#C7B36F' }}>(confluence MCP 필요)</span>
          </T.Line>
          <T.Answer>https://connecteve.atlassian.net/jira/projects/DESIGN/</T.Answer>
          <T.Line color="#8FBA70" style={{ paddingLeft: 18 }}>
            {'   '}+ Jira project · 384 issues <span style={{ color: '#C7B36F' }}>(jira MCP 필요)</span>
          </T.Line>
        ...
        <T.Q
          q="자기소개 자료 (선택)"
          required={false}
          hint="자소서·이력서·자기 소개 글 — 톤과 1인칭 표현을 잡는 데 큰 도움이 돼요"
        >
          <T.Line color="rgba(245,240,228,0.55)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'  '}지원 형식: .pdf · .md · .docx · LinkedIn URL · Notion 페이지
          </T.Line>
          <T.Answer>./이지윤-resume-2025.pdf</T.Answer>
          <T.Line color="#8FBA70" style={{ paddingLeft: 18 }}>
            {'   '}+ PDF · 320 KB · 이력서 · 4 pages
          </T.Line>
          <T.Answer>./자기소개-디자이너로의-여정.md</T.Answer>
          <T.Line color="#8FBA70" style={{ paddingLeft: 18 }}>
            {'   '}+ Markdown · 14 KB · 자기소개 에세이
          </T.Line>
          <T.Answer skipped>(빈 줄로 종료 — 또는 enter로 skip)</T.Answer>
          <T.Line color="rgba(245,240,228,0.55)" style={{ paddingLeft: 18, fontSize: 11.5 }}>
            {'  '}↗ persona/about-self.md 로 저장됩니다 — system-prompt 에 우선 인용됨
          </T.Line>
        </T.Q>
        ...
        <T.Line color="rgba(245,240,228,0.85)">
          {'  '}
          <span style={{ color: '#8FBA70' }}>✓</span> filesystem{'    '}
          <span style={{ color: 'rgba(245,240,228,0.55)' }}>이미 설치됨 (Claude Code 기본)</span>
        </T.Line>
        <T.Line color="rgba(245,240,228,0.85)">
          {'  '}
          <span style={{ color: '#C7B36F' }}>○</span> confluence{'    '}
          <span style={{ color: 'rgba(245,240,228,0.55)' }}>미설치 — Confluence URL을 입력해서 필요</span>
        </T.Line>
        <T.Line color="rgba(245,240,228,0.85)">
          {'  '}
          <span style={{ color: '#C7B36F' }}>○</span> jira{'          '}
          <span style={{ color: 'rgba(245,240,228,0.55)' }}>미설치 — Jira URL을 입력해서 필요</span>
        </T.Line>
        <T.Line color="rgba(245,240,228,0.85)">
          {'  '}
          <span style={{ color: '#8FBA70' }}>✓</span> github{'        '}
          <span style={{ color: 'rgba(245,240,228,0.55)' }}>이미 설치됨</span>
        </T.Line>
        <T.Br />

        <T.Q
          q="누락된 MCP 2개를 지금 연동할까요?"
          required
          hint="자료 조회에 꼭 필요해요. skip 하면 그 자료들은 색인에서 제외돼요"
        >
          <T.Line color="rgba(245,240,228,0.85)" style={{ paddingLeft: 0 }}>
            <span style={{ color: 'var(--brick)' }}>▸ </span>1. 지금 연동 (추천)
          </T.Line>
          <T.Line color="rgba(245,240,228,0.55)" style={{ paddingLeft: 0 }}>
            {`  2. skip — 나중에 해당 에이전트 사용 전 꼭 연동 필요`}
          </T.Line>
        </T.Q>
        <T.Answer>1</T.Answer>
        ...
        <T.Line color="#8FBA70" style={{ marginTop: 4 }}>
          {'  '}모든 자료 조회 가능 — 다음 단계로 진행
        </T.Line>

        <T.Br />
        <T.Line color="rgba(245,240,228,0.4)" style={{ fontSize: 11.5, letterSpacing: '0.04em' }}>
          {`   ── 만약 skip을 눌렀다면 ──`}
        </T.Line>
        <T.Line color="#E89A85" style={{ paddingLeft: 2 }}>
          {`  ⚠ confluence MCP 누락 — Confluence 페이지 142개를 조회할 수 없어요.`}
        </T.Line>
        <T.Line color="#E89A85" style={{ paddingLeft: 2 }}>
          {`  ⚠ jira MCP 누락 — Jira 이슈 384개를 조회할 수 없어요.`}
        </T.Line>
        <T.Line color="rgba(245,240,228,0.7)" style={{ paddingLeft: 2 }}>
          {`  → 이 에이전트를 사용하기 전 반드시 연동해 주세요:`}
        </T.Line>
        ...
        <T.Line color="rgba(245,240,228,0.5)" style={{ fontSize: 11.5 }}>
          {`  연동 안 한 상태로 ask 호출 시 답변에서 해당 자료는 빠지고 신뢰도가 낮아져요.`}
        </T.Line>

        <T.Q
          q="자신있던 영역"
          required={false}
          hint="여러 개 선택 가능 (스페이스로 토글, enter로 다음)"
        >
          <T.Line color="rgba(245,240,228,0.85)" style={{ paddingLeft: 0 }}>
          ...
          {['개발', '사업화', '영업', '마케팅', '운영', '인사', '법무', '재무', '데이터', '+ 직접 입력…'].map(
            (lbl) => (
              <T.Line key={lbl} color="rgba(245,240,228,0.55)" style={{ paddingLeft: 0 }}>
                {`  [ ] ${lbl}`}
              </T.Line>
            ),
          )}
        ...
        <T.Q
          q="이 에이전트가 사용할 수 있는 MCP"
          required={false}
          hint="현재 등록된 MCP 중에서 골라요. 비우면 모든 MCP 거부 (기본 거부 정책)"
        >
          <T.Line color="rgba(245,240,228,0.55)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'  '}현재 Claude Code에 등록된 MCP:
          </T.Line>
          <T.Line color="rgba(245,240,228,0.85)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}
            <span style={{ color: '#8FBA70' }}>✓</span> filesystem    파일 읽기 (knowledge/ 폴더 자동 포함)
          </T.Line>
          <T.Line color="rgba(245,240,228,0.85)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}
            <span style={{ color: '#8FBA70' }}>✓</span> confluence    공간 검색 (디자인 영역 토픽일 때만 의미 있음)
          </T.Line>
          <T.Line color="rgba(245,240,228,0.85)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}
            <span style={{ color: '#8FBA70' }}>✓</span> jira          이지윤이 다뤘던 이슈 검색
          </T.Line>
          <T.Line color="rgba(245,240,228,0.5)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}
            <span style={{ color: 'rgba(245,240,228,0.4)' }}>☐</span> github        (디자인 영역이라 비활성 권장)
          </T.Line>
          <T.Line color="rgba(245,240,228,0.5)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}
            <span style={{ color: 'rgba(245,240,228,0.4)' }}>☐</span> database      (디자이너에게 불필요)
          </T.Line>
          <T.Line color="rgba(245,240,228,0.5)" style={{ paddingLeft: 0, fontSize: 11.5 }}>
            {'   '}
            <span style={{ color: 'rgba(245,240,228,0.4)' }}>☐</span> postgres-prod (위험 — 명시 거부)
          </T.Line>
      ...
      <div className="helper-row">
        <div className="helper-card">
          ...
          <p style={{ lineHeight: 1.65 }}>
            모든 자료를 텍스트로 변환 → 청크 단위로 임베딩 → vector DB에 저장. ask 시 질문과 관련된 청크만 골라
            Claude의 컨텍스트로 함께 넣어요.
          </p>
        </div>
        <div className="helper-card">
          ...
          <p>
            ...
            에 허용된 MCP만 쓸 수 있어요. 디자이너 에이전트가 prod DB를 건드릴 일은 없습니다.
          </p>
        </div>
        <div className="helper-card">
