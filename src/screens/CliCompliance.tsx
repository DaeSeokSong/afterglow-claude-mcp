...
export function ScreenAudit() {
  const [tab, setTab] = useState<'immutable' | 'consent' | 'export'>("immutable");
  return (
...
/* ============================================================
   2. 신뢰도 수동 보정
   ============================================================ */
export function ScreenManualFix() {
  const [tab, setTab] = useState<'prompt' | 'edit' | 'rule'>("prompt");
  return (
    <div className="cli-page">
      <div className="cli-page-h" style={{display:"flex",alignItems:"flex-end",justifyContent:"space-between"}}>
        <div>
...
/* ============================================================
   3. 신뢰도 자동 보정
   ============================================================ */
export function ScreenAutoFix() {
  const [tab, setTab] = useState<'recalc' | 'schedule' | 'guardrail'>("recalc");
  return (
    <div className="cli-page">
      <div className="cli-page-h" style={{display:"flex",alignItems:"flex-end",justifyContent:"space-between"}}>
        <div>
