...
/* ============================================================
   ...
   ============================================================ */
export function ScreenSelfReview() {
  const [tab, setTab] = useState<'review' | 'decline' | 'resume'>('review');
  return (
...
/* ============================================================
   2. 에이전트 버전 관리
   ============================================================ */
export function ScreenVersion() {
  const [tab, setTab] = useState<'history' | 'diff' | 'tag'>('history');
  return (
    <div className="cli-page">
      <div className="cli-page-h" style={{display:"flex",alignItems:"flex-end",justifyContent:"space-between"}}>
        <div>
...
/* ============================================================
   3. 대화 로그 뷰어
   ============================================================ */
export function ScreenLogViewer() {
  const [tab, setTab] = useState<'search' | 'record' | 'replay'>('search');
  return (
    <div className="cli-page">
      <div className="cli-page-h" style={{display:"flex",alignItems:"flex-end",justifyContent:"space-between"}}>
        <div>
...
export function ScreenAccess() {
  const [tab, setTab] = useState<'default' | 'strict' | 'audit'>('default');
  return (
    <div className="cli-page">
      <div className="cli-page-h" style={{display:"flex",alignItems:"flex-end",justifyContent:"space-between"}}>
        <div>
